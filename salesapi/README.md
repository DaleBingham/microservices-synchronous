...
GET http://locahost:xxxx/salesapi/v1/api-docs/ to get the generic swagger.json file.

GET http://locahost:xxxx/salesapi/swagger-ui.html to get the generic swagger UI.
